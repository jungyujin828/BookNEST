...
1. [프로젝트 개요](#프로젝트-개요)
2. [핵심 문제의식](#핵심-문제의식)
3. [BookNest의 해결 방식](#BookNest의-해결-방식)
    1. [책을 이해하는 방식: 태그 기반 감성 분석](#책을-이해하는-방식-태그-기반-감성-분석)
    2. [사용자를 이해하는 방식: 행동 로그 기반 취향 벡터](#사용자를-이해하는-방식-행동-로그-기반-취향-벡터)
    3. [추천 전략: 실시간 + 배치 추천의 하이브리드](#추천-전략-실시간--배치-추천의-하이브리드)
4. [사람마다 다른 독서 성향: 아키타입 기반 맞춤 전략](#사람마다-다른-독서-성향-아키타입-기반-맞춤-전략)
5. [데이터 출처 및 활용 방식](#데이터-출처-및-활용-방식)
6. [주요 페이지 구성](#주요-페이지-구성)
7. [기대 효과](#기대-효과)
8. [팀](#팀)
...
개인의 취향을 이해하고 먼저 콘텐츠를 제안하는 시대에 살고 있습니다.

하지만 책은 여전히,  
내가 일일이 찾아야 하는 대상으로 남아 있습니다.

**BookNest**는 그런 고민에서 출발했습니다.  
"책은 많은데, 지금 나한테 맞는 책은 뭘까?"  
"단지 베스트셀러가 아니라, 내 감정에 맞는 책을 누군가 먼저 추천해줬으면..."
