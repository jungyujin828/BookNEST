...
| 아키타입        | 설명                                                                                      | 이미지                   |
|-----------------|-------------------------------------------------------------------------------------------|--------------------------|
| **카나리아**     | 독창적 실험가: 새로운 방식과 독특한 표현을 즐기는 독자                                       | ![카나리아 이미지](이미지_위치) |
| **알바트로스**   | 세계관 탐험가: 복잡한 세계관과 설정을 탐구하는 독자                                          | ![알바트로스 이미지](이미지_위치) |
| **독수리**       | 현실주의자: 사회적 문제를 분석하고, 냉철하게 현실을 바라보는 독자                           | ![독수리 이미지](이미지_위치) |
| **흰 오목눈이**   | 따뜻한 감성가: 감성적이고, 인간관계를 중시하는 독자                                         | ![흰 오목눈이 이미지](이미지_위치) |
| **부엉이**       | 논리적 사색가: 철학적이고 깊은 사색을 즐기는 독자                                           | ![부엉이 이미지](이미지_위치) |
| **까마귀**       | 냉철한 분석가: 미스터리와 반전을 즐기며, 날카로운 분석력을 가진 독자                       | ![까마귀 이미지](이미지_위치) |
| **앵무새**       | 명랑한 이야기꾼: 유머와 즐거운 이야기를 선호하는 독자                                     | ![앵무새 이미지](이미지_위치) |
| **플라밍고**     | 감각의 여정자: 감성적이고 신비로운 분위기의 이야기를 선호하는 독자                          | ![플라밍고 이미지](이미지_위치) |
