...
INSERT INTO user (nickname, archetype, provider, provider_id, created_at, updated_at, profile_url, gender, birthdate)
VALUES
-- M
('열정청년', '도전하는 까치', 'GOOGLE', 1111111, NOW(), NOW(), 'https://img.example.com/profile6.png', 'M', '2005-01-01'), -- 10대
('직장인A', '현실주의 올빼미', 'NAVER', 1111112, NOW(), NOW(), 'https://img.example.com/profile7.png', 'M', '1994-08-15'), -- 30대
('중년남', '느긋한 앵무새', 'KAKAO', 1111113, NOW(), NOW(), 'https://img.example.com/profile8.png', 'M', '1975-05-10'), -- 50대

-- F
('대학생F', '활발한 참새', 'KAKAO', 1111114, NOW(), NOW(), 'https://img.example.com/profile9.png', 'F', '2001-07-20'), -- 20대
('워킹맘', '다정한 제비', 'NAVER', 1111115, NOW(), NOW(), 'https://img.example.com/profile10.png', 'F', '1983-11-30'), -- 40대
( '할머니F', '지혜로운 부엉이', 'GOOGLE', 1111116, NOW(), NOW(), 'https://img.example.com/profile11.png', 'F', '1950-03-25'), -- 60대 이상

-- O (기타)
('열린사람', '자유로운 비둘기', 'KAKAO', 1111117, NOW(), NOW(), 'https://img.example.com/profile12.png', 'O', '1999-06-06'), -- 20대

-- N (성별 선택 안함)
('미정성별', '신비한 두루미', 'NAVER', 1111118, NOW(), NOW(), 'https://img.example.com/profile13.png', 'N', '1990-09-09'), -- 30대

-- NULL 성별
('빈성별1', '조용한 까마귀', 'GOOGLE', 1111119, NOW(), NOW(), 'https://img.example.com/profile14.png', NULL, '1988-12-12'), -- 30대
('빈성별2', '미소 짓는 참새', 'KAKAO', 1111120, NOW(), NOW(), 'https://img.example.com/profile15.png', NULL, '1960-02-28'); -- 60대
